...
public class Logon extends JFrame {
    ...
    public Logon(int x, int y) throws ParseException {
        ...
        // Erstelle ActionListener für Menu

        ActionListener closeListener = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                String ereignis = e.getActionCommand();
                if (ereignis.equals("Schließen")){
                    System.exit(0);
                } else {
        ...
        JMenuItem ins = new JMenuItem("Einfügen");
        JMenuItem cop = new JMenuItem("Kopieren");

        JMenuItem upd = new JMenuItem("Update");
        JMenuItem prin = new JMenuItem("Drucken");
        ...
        neu.setToolTipText("Neue Datei erstellen");
        open.setToolTipText("Datei öffnen");
        close.setToolTipText("Programm schließen");

        cut.setToolTipText("Ausschneiden der markierten Zeile");
        ins.setToolTipText("Einfügen in markierte Zeile");
        cop.setToolTipText("Kopieren der markierten Zeile");

        upd.setToolTipText("Update das Programm");
        prin.setToolTipText("Drucke das Fenster");

        // Hinzufügen auf JMenu
        ...
        // Hinzufügen auf MenuBar

        menuBar.add(dat);
        menuBar.add(edit);
        menuBar.add(help);

        // Menu auf Fenster bringen
